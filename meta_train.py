...
if args.eval_marble:
    marble_n_runs(trainer.model, args.model_name, args.alpha, args.beta_0, args.beta_1, lr=args.inner_lr, train_batch_size=args.train_batch_size, vary_train_batch_size=vary_train_batch_size, epochs=args.epochs_per_episode, n_runs=args.marble_n_runs, max_n_features=args.max_n_features, num_black = args.num_black, num_white = args.num_white)
